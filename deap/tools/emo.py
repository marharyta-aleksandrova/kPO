...
def selPO(individuals, k, nd='counting'):
    ...
    :param individuals: A list of individuals to select from.
    :param k: The number of individuals to select.
    :param nd: How pareto optimality is calculated; counting - counting measure, prob - probabilistic measure
...
__all__ = ['selPO', 'selNSGA2', 'selNSGA3', 'selNSGA3WithMemory', 'selSPEA2', 'sortNondominated', 'sortLogNondominated',
           'selTournamentDCD', 'uniform_reference_points', 'sortPO']
